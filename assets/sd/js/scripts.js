...
$(function () {
  let sidebar_nicescroll_opts = {
    cursoropacitymin: 0,
    cursoropacitymax: 0.1, // it were 0.8
    zindex: 2 //it were 892
  },
  ...
  if ($(".fetch_merged_subject").length) {
    $(".fetch_merged_subject")
      .css({
        height: 200
      })
      .niceScroll();
  ...
  if ($(".fetchStaffsAttendance").length) {
  ...
  if ($(".AssesmentMethodSetting").length) {
    $(".AssesmentMethodSetting")
      .css({
        height: 400
      })
      .niceScroll({
  ...
  if ($(".PromotionPolicySetting").length) {
    $(".PromotionPolicySetting")
      .css({
        height: 400
      })
      .niceScroll({
  ...
  if ($(".LetterGradePolicySetting").length) {
    $(".LetterGradePolicySetting")
      .css({
        height: 400
      })
      .niceScroll({
  ...
  if ($(".SocialPageLinksSetting").length) {
    $(".SocialPageLinksSetting")
      .css({
        height: 400
      })
      .niceScroll({
  ...
  if ($(".composeGradeViewHeight").length) {
    $(".composeGradeViewHeight")
      .css({
        height: 100
      })
      .niceScroll({
