      ...
      <div class="main-content">
        <section class="section">
          <div class="section-body">
            ...
            <div class="row">
                <?php foreach($read_more as $read_mores){ ?>
                          ...
                          <div class="media">
                            ...
                            <div class="media-body">
                              <span class="date pull-right">
                                ...
                                <?php echo $read_mores->date_post; ?>
                              </span>
                              <h5 class="text-primary"></h5>
                              <small class="text-muted">From: <?php echo $read_mores->fname; echo' ';
                              echo $read_mores->mname;echo ' ('.$read_mores->branch.')';?></small>
                            </div>
                          </div>
                        </div>
                        <div class="view-mail p-t-20">
                          <p>
                             <?php echo $read_mores->post; ?>
                          </p>
                        </div>
                      </section>
                    </div>
        ...
        <div class="settingSidebar">
          <a href="javascript:void(0)" class="settingPanelToggle"> <i class="fa fa-moon"></i>
          </a>
          <div class="settingSidebar-body ps-container ps-theme-default">
            <div class=" fade show active">
              <div class="p-15 border-bottom">
                <h6 class="font-medium m-b-10">Background Color</h6>
