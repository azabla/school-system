                        ...
                        <form id="save_placement" method="POST"> 
                          <div class="row">
                            <div class="form-group col-lg-3 col-6">
                              <label for="Mobile">Group/Dept. Name</label>
                              <input type="text" class="form-control" id="departmentHead" name="departmentHead" placeholder="Dept name..."> 
                            </div>
                           <div class="form-group col-lg-3 col-6">
                          ...
                          <div class="form-group  col-lg-6 col-12 table-responsive" style="height: 25vh;">
                          ...
                          <div class="col-lg-12 col-12 pull-right">
                            <button type="submit" name="postplacement" class="btn btn-info pull-right">Save Group/Dept. </button>
                          </div>
                        </div>
                      </form>
                    </div>
