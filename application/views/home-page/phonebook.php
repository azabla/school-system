                       ...
                       <div class="row">
                        <div class="col-md-3 col-6">
                           ...
                           <div class="col-lg-2 col-6">
                            <button class="btn btn-primary btn-block" name="gethisreport"> View
                           </button>
                         </div>
                          
                      </div>
                    </form>
                    <div class="listHello table-responsive" id="helloHere" style="height:45vh"></div>
                   </div>
                 </div>
                </div>
              </div>
...
<script type="text/javascript">
  $('#fetch_phone').on('submit', function(event) {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>Phonebook/fetchphone/",
      data:({
        gradesec: gradesec,
        branch: branch,
      ...
      beforeSend: function() {
        $('.listHello').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">' );
      },
