            ...
            <div class="card">
              <div class="card-body StudentViewTextInfo">
                <ul class="nav nav-tabs" id="myTab2" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab4" data-toggle="tab" href="#dataProgress" role="tab" aria-selected="false">Data Progress</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab5" data-toggle="tab" href="#reportStatistics" role="tab" aria-selected="false">Statistics</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="home-tab7" data-toggle="tab" href="#reportStatistics1" role="tab" aria-selected="false">ትንተና </a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="tab-content tab-bordered" id="myTab3Content">
                  ...
                  <div class="tab-pane fade show" id="dataProgress" role="tabpanel" aria-labelledby="home-tab4">
                    <div class="row">
                    ...
                    <form method="POST" id="showDataProgress">
                      <div class="row">
                        <div class="col-lg-2 col-6">
                          <div class="form-group">
                            <select class="form-control selectric" required="required" name="bsacademicyearDataProgress"  id="bsacademicyearDataProgress">
                            <?php foreach($academicyear as $academicyears){ ?>
                              <option value="<?php echo $academicyears->year_name;?>">
                                <?php echo $academicyears->year_name;?>
                              </option>
                          ...
                          <div class="col-lg-4 col-6">
                            <div class="form-group">
                              <select class="form-control" required="required" name="bsbranchDataProgress"
                              id="bsbranchDataProgress">
                                <option>--- Branch ---</option>
                                  <?php foreach($branch as $branchs) { ?>
                                  <option value="<?php echo $branchs->name;?>">
                                    <?php echo $branchs->name;?>
                        ...
                        <div class="col-lg-6 col-12 table-responsive" style="height: 20vh;">
                          <div class="form-group bsgradesecDataProgress" id="bsgradesecDataProgress"> 
                          </div>
                        </div>
                        <div class="col-lg-4 col-6">
                          <div class="form-group">
                            ...
                            $query=$this->db->get('kg_chibt_week_category');
                            if($query->num_rows()>0){ ?>
                              <select class="form-control" required="required" name="period_statusDataProgress" id="period_statusDataProgress">
                                <option> </option>
                                <?php foreach (range(1, 10) as $week) { ?>
                                  <option value="Week <?= $week ?>">Week <?= $week ?></option>
                                <?php } ?>
                            ...
                            <?php } else { ?>
                            <select class="form-control selectric period_statusDataProgress" required="required" name="period_statusDataProgress" id="period_statusDataProgress">
                              <option> </option>
                              <option>በመጀመሪያ</option>
                              <option>በመጨረሻ</option>                      
                            </select>
                        ...
                        <div class="col-lg-2 col-6">
                          <button class="btn btn-primary btn-block btn-lg" 
                            type="submit" name="showDataProgress">Show Progress
                          </button>
                        </div>
                      </div>
                    </form>
                    <div class="listDataProgress" id="listDataProgress"></div>
                  </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-6">
                          <div class="form-group">
                            ...
                            <?php } else { ?>
                            <select class="form-control selectric period_statusNonFilled" required="required" 
                            name="period_statusNonFilled" id="period_statusNonFilled">
                              <option> </option>
                              <option>በመጀመሪያ</option>
                              <option>በመጨረሻ</option>                      
                            </select>
                      ...
                      <div class="row">
                        <div class="col-lg-2 col-6">
                          ...
                          <div class="col-lg-3 col-6">
                            <div class="form-group">
                              <select class="form-control" required="required" name="branch_result_report"
                              id="branch_result_report">
                                <option>--- Branch ---</option>
                                  <?php foreach($branch as $branchs) { ?>
                                  <option value="<?php echo $branchs->name;?>">
                                    <?php echo $branchs->name;?>
                        ...
                        if($query->num_rows()>0){ ?>
                          ...
                          <div class="form-group" name="term_result_report_week" id="term_result_report_week">
                  ...
                  <div class="tab-pane fade show" id="reportStatistics" role="tabpanel" aria-labelledby="home-tab5">
                    ...
                    <form method="POST" id="fetchReportStatisticsKG">
                      <div class="row">
                        <div class="col-lg-2 col-6">
                          <div class="form-group">
                            <select class="form-control selectric" required="required" name="bsacademicyearRS"  id="bsacademicyearRS">
                            <?php foreach($academicyear as $academicyears){ ?>
                              <option value="<?php echo $academicyears->year_name;?>">
                                <?php echo $academicyears->year_name;?>
                              </option>
                          ...
                          <div class="col-lg-3 col-6">
                            <div class="form-group">
                              <select class="form-control" required="required" name="bsbranchRS"
                              id="bsbranchRS">
                                <option>--- Branch ---</option>
                                  <?php foreach($branch as $branchs) { ?>
                                  <option value="<?php echo $branchs->name;?>">
                        ...
                        <div class="col-lg-4 col-6">
                          <div class="form-group">
                            ...
                            <?php } else { ?>
                            <select class="form-control selectric period_statusRS" required="required" 
                            name="period_statusRS" id="period_statusRS">
                              <option> </option>
                              <option>በመጀመሪያ</option>
                              <option>በመጨረሻ</option>                      
                            </select>
                  ...
                  <div class="tab-pane fade show" id="reportStatistics1" role="tabpanel" aria-labelledby="home-tab7">
                    <div class="row">
                      <div class="col-lg-12 col-12">
                        <button class="btn btn-default pull-right" name="gethisreport" onclick="codespeedyRS_gs()">
                        <span class="text-black">
                          <i data-feather="printer"></i>
                        </span>
                        </button>
                        <button type="submit" id="dataExportExcel_gs" name="dataExport" value="Export to excel" class="btn btn-info pull-right">Export To Excel
                        </button>
                      </div>
                    </div>
                    <form method="POST" id="fetch_ReportStatistics">
                      <div class="row">
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            <select class="form-control selectric" required="required" name="bsacademicyear_RS"  id="bsacademicyear_RS">
                            <?php foreach($academicyear as $academicyears){ ?>
                              <option value="<?php echo $academicyears->year_name;?>">
                                <?php echo $academicyears->year_name;?>
                              </option>
                          ...
                          <div class="col-lg-3 col-6">
                            <div class="form-group">
                              <select class="form-control" required="required" name="bsbranch_RS"
                              id="bsbranch_RS">
                                <option>--- Branch ---</option>
                                  <?php foreach($branch as $branchs) { ?>
                                  <option value="<?php echo $branchs->name;?>">
                        ...
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            <select class="form-control bsgradesec_RS" required="required"
                             name="bsgradesec_RS" id="bsgradesec_RS">
                              <option>--- Grade ---</option>
                            </select>
                          </div>
                        </div>
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            <select class="form-control selectric bsquarter_RS" required="required" 
                            name="bsquarter_RS" id="bsquarter_RS">
                              <option>--- Category ---</option>
                        ...
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            ...
                            $query=$this->db->get('kg_chibt_week_category');
                            if($query->num_rows()>0){ ?>
                              <select class="form-control" required="required" name="period_status_RS" id="period_status_RS">
                                <option> </option>
                                <?php foreach (range(1, 10) as $week) { ?>
                                  <option value="Week <?= $week ?>">Week <?= $week ?></option>
                                <?php } ?>
                            ...
                            <?php } else { ?>
                            <select class="form-control selectric period_status_RS" required="required" 
                            name="period_status_RS" id="period_status_RS">
                              <option> </option>
                              <option>በመጀመሪያ</option>
                              <option>በመጨረሻ</option>                      
                            </select>
                        ...
                        <div class="col-lg-3 col-6">
                          <button class="btn btn-primary btn-block btn-lg" 
                            type="submit" name="viewmark">View Statistics
                          </button>
                        </div>
                      </div>
                    </form> 
                    <div class="list_RS" id="list_RS"></div>
                  </div>
                  <div class="tab-pane fade show" id="rosterSummary" role="tabpanel" aria-labelledby="home-tab6">
                    ...
                    <form method="POST" id="fetchRosterSummaryKG">
                      <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            <select class="form-control" required="required" name="bsbranchRSummary"
                            id="bsbranchRSummary">
                              <option>--- Branch ---</option>
                                <?php foreach($branch as $branchs) { ?>
                                <option value="<?php echo $branchs->name;?>">
                        ...
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            ...
                            <?php } else { ?>
                            <select class="form-control selectric period_statusRSummary" required="required" 
                            name="period_statusRSummary" id="period_statusRSummary">
                              <option> </option>
                              <option>በመጀመሪያ</option>
                              <option>በመጨረሻ</option>                      
                            </select>
...
<script type="text/javascript">
  $('#fetch_ReportStatistics').on('submit', function(event) {
    event.preventDefault();
    var branches=$("#bsbranch_RS").val();
    var gradesec=$('.bsgradesec_RS').val();
    var bsquarterRS=$('#bsquarter_RS').val();
    var period_statusRS=$('#period_status_RS').val();
    var academicyear=$('#bsacademicyear_RS').val();
    if ($('#bsquarter_RS').val() != '--- Category ---') {
      $.ajax({
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fecthReportStatistics1/",
        method: "POST",
        data: ({
          branches: branches,
          gradesec:gradesec,
        ...
        dataType:"json",
        beforeSend: function() {
          $('.list_RS').html( 'Loading<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">' );
        },
  ...
  $(document).ready(function() {  
    $(".bsgradesec_RS").bind("change", function() {
      var branches=$("#bsbranch_RS").val();
      var gradesec=$('.bsgradesec_RS').val();
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/load_kg_subject_header/",
        data: ({
          branches: branches,
          gradesec:gradesec
        }),
        beforeSend: function() {
          $('.bsquarter_RS').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="14" height="14" id="loa">' );
        },
        success: function(data) {
          $(".bsquarter_RS").html(data);
        }
      });
    });
  });
  $(document).ready(function() {  
    $("#bsbranch_RS").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Filter_grade_from_branch/",
        data: "branchit=" + $("#bsbranch_RS").val(),
        beforeSend: function() {
          $('.bsgradesec_RS').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">' );
        },
        success: function(data) {
          $(".bsgradesec_RS").html(data);
        }
      });
    });
  });
  ...
  $("#dataExportExcel_gs").click(function(e) {
  let file = new Blob([$('.list_RS').html()], {type:"application/vnd.ms-excel"});
  let url = URL.createObjectURL(file);
  let a = $("<a />", {
    href: url,
    download: "Roster Statistics.xls"}).appendTo("body").get(0).click();
    e.preventDefault();
  });
  $('#fetchRosterSummaryKG').on('submit', function(event) {
    event.preventDefault();
    var branches=$("#bsbranchRSummary").val();
    ...
    if ($('#period_statusRSummary').val() != '') {
      $.ajax({
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fecthRosterSummary/",
        method: "POST",
        data: ({
          branches: branches,
          gradesec:gradesec,
  ...
  $(document).ready(function() {  
    $("#bsbranchRSummary").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Filter_grade_from_branch/",
        data: "branchit=" + $("#bsbranchRSummary").val(),
        beforeSend: function() {
          $('.bsgradesecRSummary').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">' );
        },
        success: function(data) {
          $(".bsgradesecRSummary").html(data);
        }
      });
    });
  });
  ...
  $('#fetchReportStatisticsKG').on('submit', function(event) {
    ...
    $("input[name='kg_subject_valueGS']:checked").each(function(i){
      value_name[i]=$(this).val();
    });
    $("input[name='kg_subject_category_nameGS']:checked").each(function(i){
      header_name[i]=$(this).val();
    });
    var branches=$("#bsbranchRS").val();
    var gradesec=$('.bsgradesecRS').val();
    var bsquarterRS=$('#bsquarterRS').val();
    var period_statusRS=$('#period_statusRS').val();
    var academicyear=$('#bsacademicyearRS').val();
    if (value_name.length != 0 && header_name.length != 0) {
      $.ajax({
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fecthReportStatistics/",
        method: "POST",
        data: ({
          branches: branches,
  ...
  $(document).ready(function() {  
    $("#bsbranchRS").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/filterGradefromBranch/",
        data: "branchit=" + $("#bsbranchRS").val(),
        beforeSend: function() {
          $('.bsgradesecRS').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">' );
        },
        success: function(data) {
          $(".bsgradesecRS").html(data);
        }
      });
    });
  });
  $(document).ready(function() {  
    $(".bsquarterRS").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/load_kg_category_header/",
        data: ({
          gradesec: gradesec,
          quarter:quarter
        }),
  ...
  $(document).ready(function() {  
    $(".bsgradesecRS").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/load_kg_subject_header_grade/",
        data: ({
          branches: branches,
          gradesec:gradesec
        }),
  ...
  $(document).ready(function() {  
    $(".bsgradesecRS").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/load_kg_subject_value/",
        data: ({
          branches: branches,
          gradesec:gradesec
        }),
  ...
  $('#showDataProgress').on('submit', function(event) {
    event.preventDefault();
    grade=[];
    $("input[name='studentGradeSecJoss_dataProgress']:checked").each(function(i){
      grade[i]=$(this).val();
    });
    var branches=$('#bsbranchDataProgress').val();
    var period_status=$('#period_statusDataProgress').val();
    var academicyear=$('#bsacademicyearDataProgress').val();
    if (grade.length != 0) {
      $.ajax({
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fecthDataProgress/",
        method: "POST",
        data: ({
          branches: branches,
          gradesec:grade,
        ...
        dataType:"json",
        beforeSend: function() {
          $('.listDataProgress').html( 'Loading<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">' );
        },
        success: function(data) {
          $(".listDataProgress").html(data);
        }
      })
    }else {
      swal('Oooops, Please select necessary fields!', {
  ...
  $(document).ready(function() {  
    $("#bsbranchDataProgress").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fetchGradeSecFromBranch/",
        data: "branchit=" + $("#bsbranchDataProgress").val(),
        beforeSend: function() {
          $('.bsgradesecDataProgress').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">' );
        },
        success: function(data) {
          $(".bsgradesecDataProgress").html(data);
        }
      });
    });
  });
  $('#fetch_result_report').on('submit', function(event) {
    event.preventDefault();
    var branches=$('#branch_result_report').val();
    var gradesec=$('.grade_result_report').val();
    var quarter=$('#term_result_report').val();
    var year=$('#year_result_report').val();
    week=[];
    $("input[name='kg_subject_result_weekname']:checked").each(function(i){
      week[i]=$(this).val();
    });
    if ($('.grade_result_report').val() != '') {
      $.ajax({
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fetch_result_report/",
        method: "POST",
        data: ({
          branches: branches,
          gradesec:gradesec,
  ...
  $('#fetchNonFilledBs').on('submit', function(event) {
    ...
    var academicyear=$('#bsacademicyearNonFilled').val();
    if ($('.bsgradesecNonFilled').val() != '') {
      $.ajax({
        url: "<?php echo base_url(); ?>kgsubjectlistreport/fecthNonFilledStudentBs/",
        method: "POST",
        data: ({
          branches: branches,
          gradesec:gradesec,
...
<script type="text/javascript">
  $(document).on('change', '.insert_stu_result_value_gs', function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/updateStudentBs/",
        data: ({
          value:value,
          stuid:stuid,
          bsname:bsname,
...
<script type="text/javascript">
  function codespeedy(){
    ...
    print_area.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/custom.css" type="text/css" />');
  ...
  function codespeedyRS_gs(){
    var print_div = document.getElementById("list_RS");
    var print_area = window.open();
    print_area.document.write(print_div.innerHTML);
    print_area.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style.css" type="text/css" />');
    print_area.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/components.css" type="text/css" />');
  ...
  function codespeedyProgress(){
    var print_div = document.getElementById("listDataProgress");
    var print_area = window.open();
    print_area.document.write(print_div.innerHTML);
    print_area.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style.css" type="text/css" />');
    print_area.document.write('<link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/components.css" type="text/css" />');
...
<script type="text/javascript">
  ...
  $(document).ready(function() {  
    ...
    $("#grade_result_report").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>kgsubjectlistreport/load_kg_subject_week/",
        data: ({
          branches: branches,
          gradesec:gradesec
        }),
        beforeSend: function() {
          $('#term_result_report_week').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="14" height="14" id="loa">' );
        },
        success: function(data) {
          $("#term_result_report_week").html(data);
        }
      });
    });
  });
