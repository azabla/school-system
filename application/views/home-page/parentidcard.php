...
<body>
  ...
  <script type="text/javascript">
    $(document).on('click', '#submitBackPage', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/fetchBackIdCard/",
        data: ({
  ...
  <script type="text/javascript">
    $(document).ready(function() { 
      $('#searchStudentForTransportPlace').on("keyup",function() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>parentidcard/searchStudentsToTransportService/",
  ...
  <script type="text/javascript">
    $(document).on('click', '#fetchCustomIDCard', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/fetchCustomIDCard/",
        data: ({
  ...
  <script type="text/javascript">
    ...
    $("#branchIDBack").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/Filter_grade_from_branch_Back/",
        data: ({
            branchit: branchit,
    ...
    $("#branchID").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/Filter_grade_from_branch/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
  ...
  <script type="text/javascript">
    ...
    $("#branchID").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/filterServicePlace/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
...
<script type="text/javascript" language="javascript"> 
  ...
  <script type="text/javascript">
      $(document).on('click', '.studentServiceGrade', function() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>parentidcard/fetchThisGradeStudentIdcard/",
           data: ({
            grade: grade,
  ...
  <script type="text/javascript">
    $(document).on('click', '#generateQRCodeNow', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/fetchStudentIdcard/",
         data: ({
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>parentidcard/fetchStudentIdcardWithoutPlace/",
         data: ({
          studentList:studentList,
          gradesec:gradesec,
          branch:branch,
