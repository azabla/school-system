...
<body>
                ...
                <div class="tab-content tab-bordered" id="myTab3Content">
                  <div class="tab-pane fade show active" id="defaultIDCard" role="tabpanel" aria-labelledby="home-tab1">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-6">
                          <button class="btn btn-info btn-md pull-right" id="generateQRCodeNow" type="submit" name="gethisroster"> View ID Card
                          </button>
                        </div>
                      </div>
                  ...
                  <div class="tab-pane fade show" id="customIDCard" role="tabpanel" aria-labelledby="home-tab2">
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-lg-12 col-12">
                          <button type ="submit" class="btn btn-info pull-right" id="fetchCustomIDCard" name="fetchCustomIDCard" >View ID Card</button>
                      </div>
                    </div>
  ...
  <script type="text/javascript">
    $(document).on('click', '#submitBackPage', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/fetchBackIdCard/",
        data: ({
  ...
  <script type="text/javascript">
    $(document).ready(function() { 
      $('#searchStudentForTransportPlace').on("keyup",function() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>idcard/searchStudentsToTransportService/",
  ...
  <script type="text/javascript">
    $(document).on('click', '#fetchCustomIDCard', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/fetchCustomIDCard/",
        data: ({
  ...
  <script type="text/javascript">
    ...
    $("#branchIDBack").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/Filter_grade_from_branch_Back/",
        data: ({
            branchit: branchit,
    ...
    $("#branchID").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/Filter_grade_from_branch/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
  ...
  <script type="text/javascript">
    ...
    $("#branchID").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/filterServicePlace/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
...
<script type="text/javascript" language="javascript"> 
  ...
  <script type="text/javascript">
      $(document).on('click', '.studentServiceGrade', function() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>idcard/fetchThisGradeStudentIdcard/",
           data: ({
            grade: grade,
  ...
  <script type="text/javascript">
    $(document).on('click', '#generateQRCodeNow', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/fetchStudentIdcard/",
         data: ({
        ...
        beforeSend: function() {
          $('.idStuCardList').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">'
            );
        },
        success: function(data) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>idcard/fetchStudentIdcardWithoutPlace/",
         data: ({
          studentList:studentList,
          gradesec:gradesec,
          branch:branch,
