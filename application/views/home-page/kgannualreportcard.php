              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <div class="row"> 
                      <div class="col-lg-3 col-6">
                        <h5 class="header-title">KG Annual Card</h5>
                      </div>
                      <div class="col-lg-4 col-6">
                        <button class="btn btn-outline-success"><a href="<?php echo base_url(); ?>kgreportcard/" class="kgAnnualReportCard">KG Quarter Card </a></button>
                      </div>
                      <div class="col-lg-4 col-8">
                        <button class="btn btn-outline-success"><a href="<?php echo base_url(); ?>Kgannualreportcards/" class="kgAnnualReportCard">KG Annual Card <small>(Method 2)</small> </a></button>
                      </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="table-responsive" id="kgAnnualReportCard" style="height:40vh;"> </div>
                  </div>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
  $(document).ready(function() {  
    $("#grands_branchit").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Kgannualreportcard/filterGradefromBranch/",
        data: ({
          branchit: branchit,
  ...
  $('#comment_form').on('submit', function(event) {
    ...
    var rpQuarter=$('#rpQuarter').val();
      if ($('#grands_gradesec').val() != '' && $('#grands_branchit').val() != '' ) {
        $.ajax({
          url: "<?php echo base_url(); ?>Kgannualreportcard/fetchKgStudentAnnualReportCard/",
          method: "POST",
          data: ({
            gradesec:gradesec,
            branch:branch,
