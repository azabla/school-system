                    ...
                    <form method="POST" id="submit_branch">
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                          <button class="btn btn-primary btn-lg btn-block" name="gethisreport" type="submit" >Submit
                          </button>
                        </div>
                      </div>
                    </form>
                    <div class="reportHere card-body" id="helloioHere"> </div>
                  </div>
                </div>
              </div>                
            </div>
...
<script type="text/javascript">
  $('#submit_branch').on('submit', function(event) {
    event.preventDefault();
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>This_gradestatistics/",
        data: ({
          gradesec: gradesec,
          branch:branch
        }),
