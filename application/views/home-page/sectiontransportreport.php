                ...
                <form method="POST" id="comment_form">
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-12 pull-right">
                      ...
                      <button class="btn btn-primary pull-right" type="submit" name="viewmark">View Report</button>
                    </div>
                  </div>
                </form>
...
<script type="text/javascript">
    function selectAllPlaceListRecordSection(){
        var itemsall=document.getElementById('selectallServicePlaceListSectionReport');
        if(itemsall.checked==true){
        var items=document.getElementsByName('studentServicePlaceSectionReport[ ]');
...
<script type="text/javascript">
    ...
    $("#grands_branchit").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>sectiontransportreport/filterServicePlace/",
        data: ({
            branchit: branchit,
...
<script type="text/javascript">
  $('#comment_form').on('submit', function(event) {
    ...
    $("input[name='summaryGSGradeSec']:checked").each(function(i){
      summaryGSGrade[i]=$(this).val();
    });
    $("input[name='studentServicePlaceSectionReport[ ]']:checked").each(function(i){
    ...
    $.ajax({
        url: "<?php echo base_url(); ?>sectiontransportreport/FecthThisGradeStudentService/",
        method: "POST",
        data: ({
...
<script type="text/javascript">
  $(document).ready(function() {  
    $("#grands_branchit").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>sectiontransportreport/filterGrade/",
