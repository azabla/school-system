...
<body>
                ...
                <div class="tab-content tab-bordered" id="myTab3Content">
                      ...
                      <div class="row">
                        <div class="col-lg-2 col-6">
                          <div class="form-group">
                            <select class="form-control" required="required"  name="reportaca" id="reportacaID">
                        ...
                        <div class="col-lg-3 col-6">
                          <div class="form-group">
                            <select class="form-control" required="required" name="branch" id="branchID">
                  ...
                  <div class="tab-pane fade show" id="backPage" role="tabpanel" aria-labelledby="home-tab3">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3 col-6">
                        <select class="form-control" id="gradesecIDBack">
                          <option>--Grade--</option>
                      ...
                      <div class="col-lg-3 col-6">
                        <button type="button" class="btn btn-primary btn-block" id="submitBackPage">View Card</button>
                      </div>
                    </div>
  ...
  <script type="text/javascript">
    $(document).on('click', '#submitBackPage', function() {
      ...
      var gradesecIDBack=$('#gradesecIDBack').val();
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/fetchBackIdCard/",
        data: ({
          pageNumber: pageNumber,
          branchIDBack:branchIDBack,
          gradesecIDBack:gradesecIDBack
        }),
        beforeSend: function() {
          $('#fetchBackIDCardHere').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">'
            );
        },
  ...
  <script type="text/javascript">
    $(document).ready(function() { 
      $('#searchStudentForTransportPlace').on("keyup",function() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>libraryidcard/searchStudentsToTransportService/",
          data: "searchItem=" + $("#searchStudentForTransportPlace").val(),
          beforeSend: function() {
            $('.searchPlaceHere').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">' );
          },
          success: function(data) {
  ...
  <script type="text/javascript">
    $(document).on('click', '#fetchCustomIDCard', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/fetchCustomIDCard/",
        data: ({
          stuIdArray: stuIdArray
        }),
        beforeSend: function() {
          $('.fetchCustomIDCardHere').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">'
            );
        },
        success: function(data) {
  ...
  <script type="text/javascript">
    $(document).ready(function() {  
    $("#branchIDBack").bind("change", function() {
      var branchit=$('#branchIDBack').val();
      var grands_academicyear=$('#reportacaID').val();
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/Filter_grade_from_branch_Back/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
        beforeSend: function() {
          $('#gradesecIDBack').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">' );
        },
        success: function(data) {
          $("#gradesecIDBack").html(data);
        }
      });
    });
  });
    ...
    $("#branchID").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/Filter_grade_from_branch/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
        beforeSend: function() {
          $('#gradesecID').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="14" height="14" id="loa">' );
        },
        success: function(data) {
  ...
  <script type="text/javascript">
    ...
    $("#branchID").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/filterServicePlace/",
        data: ({
            branchit: branchit,
            grands_academicyear:grands_academicyear
        }),
        beforeSend: function() {
          $('#placeID').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="14" height="14" id="loa">' );
        },
        success: function(data) {
          $("#placeID").html(data);
        }
...
<script type="text/javascript" language="javascript"> 
  ...
  <script type="text/javascript">
      $(document).on('click', '.studentServiceGrade', function() {
        ...
        var academicyear=$("#studentListPLace").val();
        if($(".studentServiceGrade").val()!=''){
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>libraryidcard/fetchThisGradeStudentIdcard/",
           data: ({
            grade: grade,
            academicyear:academicyear
          }),
          beforeSend: function() {
            $('#studentID').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">'
              );
          },
          success: function(data) {
            $("#studentID").html(data);
  ...
  <script type="text/javascript">
    $(document).on('click', '#generateQRCodeNow', function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/fetchStudentIdcard/",
         data: ({
        ...
        beforeSend: function() {
          $('.idStuCardList').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">'
            );
        },
        success: function(data) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>libraryidcard/fetchStudentIdcardWithoutPlace/",
         data: ({
          studentList:studentList,
          gradesec:gradesec,
          branch:branch,
