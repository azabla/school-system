          ...
          <div class="section-body">
            <div class="row">
              ...
              <div class="card">
                ...
                <form method="POST" id="NgMarkForm" class="StudentViewTextInfo">
                  <div class="row">
                    ...
                    <div class="col-lg-6 col-6 table-responsive" style="height:15vh">
                      <div class="grands_gradesec " id="grands_gradesec" ></div>
                    </div>
                    <div class="col-lg-6 col-6 table-responsive" style="height:25vh">
...
<script type="text/javascript">
  $(document).ready(function() {  
    $("#gradesec_mformat").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Filtertermfromgrade/",
        data: "gradeit=" + $("#gradesec_mformat").val(),
        beforeSend: function() {
...
<script type="text/javascript">
  $(document).ready(function() {  
    $("#grands_branchit").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Ngmarkresult/filterGradesecToNGMarkShow/",
  ...
  $(document).on('click', '.gradesec2ShowNgmark', function() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>Ngmarkresult/filterSubjectToNGMarkShow/",
      data:({
  ...
  $(document).on('click', '.gradesec2ShowNgmark', function() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>Ngmarkresult/filterQuarterToNGMarkShow/",
      data:({
        grade2analysis:grade2analysis
      }),
      beforeSend: function() {
...
<script type="text/javascript">
  $('#NgMarkForm').on('submit', function(event) {
    ...
    if (gs_gradesec.length==0 || gs_subject.length==0) {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>Ngmarkresult/fetchNullMark/",
        method: "POST",
        data: ({
        ...
        beforeSend: function() {
          $('.nullmarkHere').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">' );
        },
        success: function(data) {
