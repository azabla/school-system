...
<script type="text/javascript">
  $(document).ready(function() { 
      $('#itemQuantity').on("keyup",function() {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>requestitem/validate_item_quantity/",
          data: ({
          ...
          success: function(data) {
            if(data >= itemQuantity){
              ...
              $(".validate_num_rows").html('<span class="text-danger"><i class="fas fa-times"> </i> No stock</span>');
  ...
  {
    $.ajax({
      url:"<?php echo base_url(); ?>requestitem/fetch_myrequested_item/",
      method:"POST",
      beforeSend: function() {
  ...
  $(document).on('click', '#submitItemQuantity', function() {
    ...
    if($('#item_option').val()!='Select Item' && $('#itemQuantity').val()!=''){
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>requestitem/submit_request/",
        data: ({
          item_option: item_option,
          itemQuantity:itemQuantity
        }),
  ...
  $(document).on('click', '#delete_this_myrequest', function() {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>requestitem/delete_request_item/",
          data: ({
            requestid: requestid
          }),
          cache: false,
