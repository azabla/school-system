                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                      <div class="tab-pane fade show active" id="evaluationRank" role="tabpanel" aria-labelledby="home-tab1">
                        <div class="row">
                          ...
                          <div class="col-md-12 col-12">
                            <button class="btn btn-primary pull-right viewanalysis"> View Analysis
                            </button>
                          </div>
                        </div>
                      ...
                      <div class="tab-pane fade show" id="assesmentRank" role="tabpanel" aria-labelledby="home-tab2">
                        <div class="row">
                          <div class="col-md-12 col-12">
                           ...
                           <div class="col-lg-3 col-6">
                            <div class="form-group">
                             <select class="form-control selectric" required="required" name="branch_valuation" id="branch_valuation">
                             <option>--- Select branch ---</option>
                              <?php foreach($branch as $branchs){ ?>
                                <option value="<?php echo $branchs->name;?>">
                                <?php echo $branchs->name;?>
                          ...
                          <div class="col-md-12 col-12">
                            <button class="btn btn-primary pull-right view_assesmentanalysis"> View Analysis
                            </button>
                          </div>
                        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {  
    $("#branch_valuation").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>assesmentrank/filterGradefromBranch/",
        data: "branchit=" + $("#branch_valuation").val(),
        beforeSend: function() {
          $('#grade2analysis_evaluation').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">' );
        },
        success: function(data) {
          $("#grade2analysis_evaluation").html(data);
        }
      });
    });
  });
  $(document).ready(function() {  
    $("#admin_branch").bind("change", function() {
      $.ajax({
        ...
        beforeSend: function() {
          $('#grade2analysis').html( '<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">' );
        },
        success: function(data) {
...
<script type="text/javascript">
  $(document).ready(function() {
    $("#grade2analysis_evaluation").bind("change", function() {
      var branch2analysis=$("#branch_valuation").val();
      var grade2analysis=$("#grade2analysis_evaluation").val();
       var analysis_quarter=$("#evaluation_quarter").val();
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>assesmentrank/filter_assesment4analysis/",
        data:({
  ...
  $(document).ready(function() {
    $("#grade2analysis").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>assesmentrank/filter_evaluation4analysis/",
        data:({
          branch2analysis:branch2analysis,
          grade2analysis:grade2analysis,
          analysis_quarter:analysis_quarter
...
<script type="text/javascript">
  $(document).on('click', '.view_assesmentanalysis', function() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>assesmentrank/fetch_assesment_analysis/",
      method: "POST",
      data: ({
        branch: branch,
        gradesec:gradesec,
  ...
  $(document).on('click', '.viewanalysis', function() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>assesmentrank/fetch_analysis/",
      method: "POST",
      data: ({
        branch: branch,
        gradesec:gradesec,
