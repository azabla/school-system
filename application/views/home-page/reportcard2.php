              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <div class="row"> 
                      <div class="col-md-4">
                        <h4><a href="<?php echo base_url() ?>reportcard/"><small class="text-muted">Report Card (Method 1)</small> </a></h4>
                      </div>
                      <div class="col-md-4">
                     ...
                     <div class="row">
                      ...
                      <div class="form-group">
                       ...
                       <div class="col-lg-1">
                        ...
                        type="submit" name="gethisreport"> Show
                        </button>
                      </div>
                    </div>
                   </form>
                    <div class="row">
                      <div class="col-lg-12 list" id="hello">
                      </div>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
  $('#comment_form').on('submit', function(event) {
    ...
    var rp_quarter=$('#rp_quarter').val();
    var branch=$('#grands_branchit').val();
    var reportaca=$('#reportaca').val();
      if ($('#grands_gradesec').val() != '' && $('#grands_branchit').val() != '' ) {
        $.ajax({
          url: "<?php echo base_url(); ?>reportcard2/Fetch_studentreportcard2/",
          method: "POST",
          data: ({
            gradesec:gradesec,
            rp_quarter:rp_quarter,
            branch:branch,
            reportaca:reportaca

            }),
          beforeSend: function() {
            $('.list').html('Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="44" height="44" id="loa">');
          },
          success: function(data) {
            $(".list").html(data);
          }
