  ...
  <div class="container">
    ...
    <section id="ccr-left-section" class="col-md-8">
        <div class="ccr-gallery-ttile">
          <span></span> 
          <p><strong>School Blog</strong></p>
        </div>
      <section id="ccr-blog">
        <?php foreach($blogs as $blog){ $pageTitle=$blog->ntitle;  ?>
        <article>
          <figure class="blog-thumbnails">
          <img src="<?php echo base_url(); ?>/news/<?php echo $blog->photo;?>" alt="Article Image ">
          </figure>
          <div class="blog-text">
            <h1><a href="<?php echo base_url()?>singlepage?blog=<?php echo $pageTitle; ?>"><?php echo $blog->ntitle;?></a></h1>
            <p><?php echo substr($blog->description,0,700); ?>...<span class="read-more"><a href="<?php echo base_url()?>singlepage?blog=<?php echo $pageTitle; ?>">Read More</a></span>
            </p>
          </div>          
        </article>
        <?php } ?>
