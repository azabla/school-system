        ...
        <ul class="blog-s3">
          ...
          <li>
            <article>
              ...
              <div class="blog-text">
                <h4><a href="#">Position:<a href="#"><?php echo $blog->vposition;?></a></h4>
                <p>
                  <?php echo $blog->post;?>
                </p>
                
                <div class="meta-data">     
                  <a href="#" class="likde">Posted By: <?php echo $blog->fname; echo ' '; echo $blog->mname;?></a>
                  <a href="#" class="comments"><?php echo $blog->datepost;?></a>      
                  <span class="read-more"><a href="<?php echo base_url()?>applyjob?job=<?php echo $blog->vid; ?>">Apply for position <?php echo $blog->vposition; ?></a></span>
                </div>
              </div> 
            </article>
          </li>
