            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
                <div class="card">
                  <div class="boxs mail_listing">
                    ...
                    <div class="row">
                    <div class="col-lg-12">
                    <?php echo form_open_multipart('replayworksheet/');?>
                      <div class="composeForm">
                          ...
                          <div class="form-group">
                           ...
                           <option>--- Select Subject ---</option>
                            <?php foreach($fetch_gradesec as $fetch_gradesecs){ ?>
                              <option value="<?php echo $fetch_gradesecs->Subj_name;?>">
                              <?php echo $fetch_gradesecs->Subj_name;?>
                              </option>
                            <?php }?>
                           </select>
                            </div>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label for="Mobile">Worksheet title</label>
                            <div class="form-line">
                              <input type="text" 
                              id="title" name= "title"required="required" 
                               class="form-control" placeholder="Worksheet title here...">
                              </div>
                             </div>
                            </div>
                           </div>
                          ...
                          <label class="custom-file-label" for="customFile">Choose file(Doc/Pdf)</label>
                         </div>
                        <div class="m-l-25 m-b-20">
                          <button type="submit" name="answerworksheet" class="btn btn-info btn-border-radius waves-effect">Send
                          </button>
