  ...
  <div class="container">
    <section id="ccr-left-section" class="col-md-8">
      <section id="ccr-contact-form">
        ...
        <form action="<?php echo base_url() ?>Authenticationpage/" method="POST">
          <input type="number" name="my_otp" class="form-control" placeholder="Enter OTP..." required>
          <button type="submit" class="btn btn-block" name="sendOTP">Verify OTP</button>
        </form>
      </section>
    </section>
