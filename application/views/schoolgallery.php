...
<header> 
  <section id="ccr-site-title" class="container" class="container">
  ...
  <div class="container">
    <section id="ccr-left-section" class="col-md-8">
      <div class="ccr-gallery-ttile">
          <span></span> 
          <p><strong>School Gallery</strong></p>
        </div>
      <section id="ccr-blog-s2">
        <ul>
          <?php foreach($fetch_galleryToWebsite as $fetch_single_gallery){ ?>
          <li>
            <article>
              <figure class="blog-thumbnails">
              <img src="<?php echo base_url(); ?>/gallery/<?php echo $fetch_single_gallery->gname;?>" alt="Article Image ">
              </figure> <!-- /.blog-thumbnails -->
              <div class="blog-text">
                <h4><a href="#"><?php echo $fetch_single_gallery->gtitle;?></a></h4>
              </div> 
            </article>
          </li>
          <?php } ?>
