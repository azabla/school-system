          ...
          <div class="section-body">
            ...
            <div class="card">
              <ul class="nav nav-tabs" id="myTab2" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab1" data-toggle="tab" href="#feedStaffAttendance" role="tab" aria-selected="true"> <h5 class="card-title">Manage Attendance</h5></a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="home-tab2" data-toggle="tab" href="#fetchAttendanceReport" role="tab" aria-selected="false"><h5 class="card-title">Attendance Report</h5></a>
                </li>
              </ul>
              <div class="tab-content tab-bordered" id="myTab3Content">
                <div class="tab-pane fade show active" id="feedStaffAttendance" role="tabpanel" aria-labelledby="home-tab1">
                  <div class="card-body">
                    <div class="fetchStaffHH table-responsive" style="height:50vh;"></div>
                  </div>
                </div>
                <div class="tab-pane fade show" id="fetchAttendanceReport" role="tabpanel" aria-labelledby="home-tab2">
                  <div class="fetchStaffsAttendance table-responsive" style="height:50vh;"></div>
                </div>
              </div>
            </div>
          </div>
  ...
  $(document).ready(function() {
    ...
    function loadStaffs(){
      $.ajax({
        ...
        method:"POST",
        beforeSend: function() {
          $('.fetchStaffHH').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">');
        },
  ...
  $(document).ready(function() {  
    ...
    function loadStaffsAttendance(){
      $.ajax({
        ...
        method:"POST",
        beforeSend: function() {
          $('.fetchStaffsAttendance').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">');
        },
        success:function(data){
          $('.fetchStaffsAttendance').html(data);
        }
      });
    }
    ...
    $(document).on('click', '#lateStaff', function() {
      ...
      if ($('#todayDate').val()!=='' && $('#lateMinute').val()!=='') {
        ...
        alert('Please select all necessary fields to feed attendance.')
      }
    });
