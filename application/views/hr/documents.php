...
<body>
          ...
          <div class="section-body">
            ...
            <form id="mydocument" method="POST">
              <div class="row">
                ...
                <div class="col-lg-5">
                  <button type="submit"  name="post" class="btn btn-primary m-t-15 waves-effect">Save File</button>
                </div>
              </div>
            </form>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        ...
        {
          $.ajax({
            url:"<?php echo base_url(); ?>staffdocuments/fetchdocuments/",
            method:"POST",
            beforeSend: function() {
        ...
        $('#mydocument').on('submit', function(e) {
          ...
          if($('#mydoc').val() =='')
          {
            ...
            $.ajax({
            method: "POST",
            url: "<?php echo base_url(); ?>staffdocuments/postdocuments/",
  ...
  $(document).ready(function() {
     $(document).on('click', '.deletemydocument', function() {
      ...
      if (confirm("Are you sure you want to delete this file permanently ?")) 
      {
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>staffdocuments/Deletedocuments",
          data: ({
            id: id
          }),
          cache: false,
