                  ...
                  <div class="article-details">
                    <div class="article-category">
                      <div class="bullet"></div>
                       ...
                       <a href="#">
                        <button class="btn btn-default deletelesson" name="deletelesson" type="submit" id="<?php echo $exams->examname; ?>">
                    ...
                    <form action="<?php echo base_url()?>readmyexam/" method="POST">
                      <input type="hidden" name="subject" value="<?php echo $exams->subject;?>">
                    <div class="article-cta">
                      <?php 
                      $aca=$exams->academicyear;
                      $subject=$exams->subject;
                      $examname=$exams->examname;
                      $sid=$_SESSION['id'];

                      $query=$this->db->query("
                      select * from examtried where stuid='$sid' and academicyear='$aca' and triedsubject='$subject' and triedexam='$examname'");
                       if($query->num_rows() >0 ){?>
                      <button name="readmore" disabled="disabled" value="<?php echo $exams->examname; ?>" class="btn btn-info" type="submit" onclick=" return confirm('Are you sure you want to start this exam? Once You start you can not quit.')">Start Test
                      </button>
                    <?php } else{?>
                      <button name="readmore" value="<?php echo $exams->examname; ?>" class="btn btn-info" type="submit" onclick=" return confirm('Are you sure you want to start this exam? Once You start you can not quit.')">Start Test
                      </button>
