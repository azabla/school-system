            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="card">
                  <div class="card-header">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="row">
                          <div class="col-lg-6">
                            <form class="" action="<?php echo base_url(); ?>mystudent/downloadStuData/">
                              <button type="submit" id="downloadStuData" name="downloadStuData" class="btn btn-secondary"> Download Student Data <i data-feather="download"></i>
                              </button>
                            </form>
                          </div>
                          <div class="col-lg-6">
                  ...
                  <div class="myliststudent table-responsive" id="student_view" style="height:40vh;"></div>
                </div>
                </div>
  ...
  $(document).ready(function() { 
    $('#searchStudent').on("keyup",function() {
      ...
      $.ajax({
        ...
        beforeSend: function() {
          $('.myliststudent').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">' );
        },
