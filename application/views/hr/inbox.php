...
<body>
            ...
            <div class="row">
                  ...
                  <div class="body">
                    <div id="mail-nav">
                      <ul class="" id="mail-folders">
                        ...
                        <li class="active">
                          <a href="javascript:;" title="Inbox">Inbox ()
                          </a>
                        </li>
                        <li>
              ...
              <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                <div class="card">
                  ...
                  <form action="<?php echo base_url()?>mystaffinbox/" method="POST">
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        ...
                        <tbody>
                          ...
                          <td><?php echo $allmessage->date_sent; ?></td>
                          </tr>
                        <?php } ?>
                        </tbody>
                      </table>
  ...
  <script src="<?php echo base_url(); ?>assets/js/page/chat.js"></script>
