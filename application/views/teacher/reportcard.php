        ...
        <section class="section">
          <div class="section-body">
            ...
            <ul class="nav nav-tabs" id="myTab2" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="home-tab1" data-toggle="tab" href="#defaultReportCard" role="tab" aria-selected="true">Default Report card</a>
              </li>
              <li class="nav-item">
            ...
            <div class="tab-content tab-bordered" id="myTab3Content">
              <div class="tab-pane fade show active" id="defaultReportCard" role="tabpanel" aria-labelledby="home-tab1">
                <div class="row">
                  <div class="col-12">
                    <div class="card">
                        ...
                        <form id="comment_form">
                         <div class="row">
                           <div class="col-lg-3 col-6">
                             ...
                             <div class="col-lg-3 col-6">
                              <div class="form-group">
                               <select class="form-control" required="required" name="gradesec" id="grands_gradesec">
                               <option> --- Grade --- </option>
...
<script type="text/javascript">
  $(document).ready(function() {  
    $("#reportaca").bind("change", function() {
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Studentreportcard/filterQuarterfromAcademicYear/",
...
<script type="text/javascript">
  $('#comment_form').on('submit', function(event) {
    ...
    var rpQuarter=$('#rpQuarter').val();
      if ($('#grands_gradesec').val() != '' && $('#grands_branchit').val() != '' ) {
        $.ajax({
          url: "<?php echo base_url(); ?>Studentreportcard/Fetch_studentreportcard/",
          method: "POST",
          data: ({
            gradesec:gradesec,
            branch:branch,
  ...
  $('#comment_form2').on('submit', function(event) {
    ...
    var rpQuarter=$('#rpQuarter2').val();
      if ($('#grands_gradesec2').val() != '' && $('#grands_branchit2').val() != '' ) {
        $.ajax({
          url: "<?php echo base_url(); ?>Studentreportcard/fetchStudentforCustom/",
          method: "POST",
          data: ({
            gradesec:gradesec,
            branch:branch,
  ...
  $(document).on('click', '.printThisStudentReport', function() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>Studentreportcard/fetchThisStudentReportcard/",
      method: "POST",
      data: ({
        id:id,
        quarter:quarter,
