              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body StudentViewTextInfo">
                    <div class="fetch_my_notification"></div>
                  </div>
                </div>
              </div>
            </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>Mynotification/Fetch_my_notification/",
        method:"POST",
        beforeSend: function() {
          $('.fetch_my_notification').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="34" height="34" id="loa">');
        },
        success:function(data){
          $('.fetch_my_notification').html(data);
        }
      })
    }
  });
