...
<body>
                      ...
                      <div class="article-details">
                        <div class="article-category">
                          ...
                          <div class="dropdown-divider"></div>
                            <small class="text-muted">
                              <?php if($lessonplans->postby == $_SESSION['username'] || $_SESSION['usertype']=='Director'){ ?>
                        ...
                        <div class="article-user">
                          ...
                          <div class="article-user-details">
                            <a href="#"><?php echo $lessonplans->postby;?></a>
  ...
  <script type="text/javascript">
    $('#lesson_plan').on('submit', function(event) {
      ...
      $.ajax({
        url: "<?php echo base_url(); ?>viewmylessonplan/savelessonplan/",
        method: "POST",
        data: form_data,
        beforeSend: function() {
  ...
  <script type="text/javascript">
    $(document).on('click', '.deletelessonplan', function() {
      ...
      if (confirm("Are you sure you want to delete this Lesson plan ?")) {
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>viewmylessonplan/deleteViewLessonPlan/",
          data: ({
    ...
    $(document).on('click', '.editlessonplan', function() {
      ...
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>viewmylessonplan/EditLessonPlan/",
        data: ({
    ...
    $(document).on('click', '#saveChanges', function() {
      ...
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>viewmylessonplan/updateLessonPlan/",
        data: ({
    ...
    $(document).on('click', '.viewlessonplan', function() {
      ...
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>viewmylessonplan/viewLessonPlanHere/",
        data: ({
