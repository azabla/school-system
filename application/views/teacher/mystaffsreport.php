...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>Mystaffsreport/fetch_my_userstasks_report/",
        method:"POST",
        beforeSend: function() {
    ...
    $(document).on('click', '.fetch_thistaskUsers', function() {
      ...
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>Mystaffsreport/fetch_usersTask_progress/",
        data: ({
          taskName: taskName,
          id:id
        }),
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>Mystaffsreport/fetchTasks/",
        method:"POST",
        beforeSend: function() {
    ...
    $(document).on('click', '#editThisTask', function() {
      ...
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>Mystaffsreport/editThisTaskName/",
        data: ({
          taskName: taskName
        }),
        cache: false,
    ...
    $(document).on('click', '#deleteThisTask', function() {
      ...
      if (willDelete) {
        ...
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>Mystaffsreport/deleteTaskName/",
          data: ({
            taskName: taskName
          }),
          cache: false,
    ...
    $(document).on('submit', '#submiteditedTask', function(e) {
      ...
      if ($('#editedtaskName').val() != '' && $('#editedwhoseTask').val() != 'Select User') {
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>Mystaffsreport/saveEditedTasks/",
    ...
    $(document).on('submit', '#newTask', function(e) {
      ...
      if ($('#taskName').val() != '' && $('#whoseTask').val() != 'Select User' && $('#taskType').val() != 'Task Type') {
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>Mystaffsreport/saveNewTasks/",
          data:new FormData(this),
          processData:false,
          contentType:false,
          cache: false,
    ...
    $(document).on('keyup', '#searchTask', function(e) {
      ...
      if($('#searchTask').val()!=''){
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>Mystaffsreport/searchTasks/",
