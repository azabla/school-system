          ...
          <div class="section-body">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <?php } ?>
                <form method="POST" action="<?php echo base_url();?>Importfile/" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-lg-4 col-6">
                      ...
                      <select class="form-control custom-select"
                       ...
                       <option></option>
                       <option value="student">Import Student </option>
                    ...
                    <div class="col-lg-3 col-12">
                      <button type="submit" name="importmater" id="importmater" class="btn btn-primary btn-block"> 
                        Import & Save
                      </button>
                    </div>
                  </div>
