                      ...
                      <div class="tab-pane fade show active" id="ReasonForIssue" role="tabpanel" aria-labelledby="home-tab1">
                        <div class="alert alert-light alert-dismissible show fade">
                          <div class="alert-body">
                            ...
                            Note:Create Issue Reason other than "Completed Grade" Reason. It is default for all students.
                          </div>
                        </div>
                        <div class="row">
...
<script type="text/javascript">
  $('.viewtranscript').on('click', function(event) {
    ...
    if ($('#gradesec_tr').val() != '' && $('#noGrade').val()!='--No of Grade--' ) {
      $.ajax({
        url: "<?php echo base_url(); ?>Studentranscript/fetchtranscript/",
        method: "POST",
        data: ({
        ...
        beforeSend: function() {
          $('.lisTranscript').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">' );
        },
  ...
  $(document).on('change', '#setleavingreason', function() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>Studentranscript/updateStudentLeavingStatus/",
      data: ({
        id:id,
  ...
  $('.viewStudent').on('click', function(event) {
    ...
    if ($('#gradesec_tr').val() != '') {
      $.ajax({
        url: "<?php echo base_url(); ?>Studentranscript/fetchStudentForEdit/",
        method: "POST",
        data: ({
          academicyear: academicyear,
          gradesec:gradesec
        ...
        beforeSend: function() {
          $('.editIssueReasonGS').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">' );
        },
        success: function(data) {
  ...
  $(document).ready(function() {  
    $("#branchEditReason").bind("change", function() {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Studentranscript/filterGradefromBranch/",
        data: ({
          academicyear:academicyear
        }),
        beforeSend: function() {
...
<script type="text/javascript">
  $(document).on('click', '#viewCustomtranscript', function() {
    ...
    if ($('#gradeCustom').val() != '' && $('#noGradeCustom').val()!='--No of Grade--' ) {
      $.ajax({
        url: "<?php echo base_url(); ?>Studentranscript/fetchStudentforCustom/",
        method: "POST",
        data: ({
          gradesec:gradesec,
          academicyear:academicyear
        ...
        dataType: 'json',
        beforeSend: function() {
          $('.lisTCustomTranscript').html('Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">');
        },
        success: function(data) {
   ...
   $(document).on('click', '.printThisStudentTranscript', function() {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>Studentranscript/fetchThisStudentTranscript/",
      method: "POST",
      data: ({
        id:id,
        username:username,
  ...
  $(document).ready(function() {  
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>Studentranscript/fetchReasonIssue/",
        method:"POST",
        beforeSend: function() {
          $('.viewReasonIssue').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">');
        },
        success:function(data){
    ...
    $('#saveReason').on('click', function(event) {
      ...
      if ($('#reasonForIssue').val() != '') {
        $.ajax({
          url: "<?php echo base_url(); ?>Studentranscript/saveReasonIssue/",
          method: "POST",
          data: ({
            reasonIssue: reasonIssue
          }),
          beforeSend: function() {
            $('#reasonForIssue').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="74" height="74" id="loa">' );
          },
          success: function(data) {
            load_data();
            $('#reasonForIssue').val('')
     ...
     swal({
      ...
      .then((willDelete) => {
        if (willDelete) {
          ...
          $.ajax({
            url: "<?php echo base_url(); ?>Studentranscript/deleteReasonIssue/",
            method: "POST",
            data: ({
