              ...
              <div class="col-12">
                ...
                <div class="card">
                  ...
                  <div class="tab-content tab-bordered" id="myTab3Content">
                    <div class="tab-pane fade show active" id="feedStuAttendance" role="tabpanel" aria-labelledby="home-tab2">
                      <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                          <button class="card card-body bg-info btn-block" id="fetchStu"> View</button> 
                        </div>
                      </div>
                    ...
                    <div class="AttendanceReport" id="AttendanceReport">
                    </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  $(document).ready(function() {  
    ...
    if(attendanceType==='Tardy'){
      var attendanceMinute=document.getElementById('attendanceMinuteTeacher_'+stuid).value;
      $.ajax({
        ...
        beforeSend: function() {
          $('.savedAttendanceTeacher'+id+attendanceType).html( '<img src="<?php echo base_url() ?>img/loader.gif" alt="" width="15" height="15" id="loa">'
            );
        },
        dataType:"json",
        success: function(data) {
          loadStaffsAttendance();
          $('.savedAttendanceTeacher' +id+attendanceType).html('');
          iziToast.success({
            title: 'Attendance',
