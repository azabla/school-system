                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4 col-6">
                             ...
                             <div class="col-lg-4 col-12">
                              ...
                              type="submit" name="viewmark">Load Staff</button>
                            </div>
                          </div>
                        </form>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#emp_attendanceTable').DataTable({
      ...
      'serverMethod': 'post',
      'ajax': {
        'url':'<?=base_url()?>mystaffevaluationattendance/fetchAttendanceReport/'
      },
      'columns': [
         { data: 'fname' },
         { data: 'absentype' },
  ...
  $(document).on('submit', '#comment_staff_tosupervision', function(e) {
    ...
    if ($('#teacher_supervision_comment_gs').length != 0) {
      $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>mystaffevaluationattendance/save_supervision_attendance_comment/",
  ...
  $(document).on('click', '.add_comment_tostaff_supervision', function()
  {
    ...
    $.ajax({
      url:"<?php echo base_url(); ?>mystaffevaluationattendance/add_comment_tostaff_supervision/",
      data: ({
        username: username,
        year:year,
  ...
  $('#customForm').on('submit', function(event) {
    ...
    $.ajax({
      url: "<?php echo base_url(); ?>mystaffevaluationattendance/fetchCustomStudentsAttendance/",
      method: "POST",
      data: ({
  ...
  $(document).on('click', '.deleteThisStaffEvaluationAttendane', function() {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>mystaffevaluationattendance/deleteAttendance/",
          data: ({
...
<script type="text/javascript">
  $('#comment_form').on('submit', function(event) {
    ...
    if ($('.gradesec').val() != '') {
      $.ajax({
        url: "<?php echo base_url(); ?>mystaffevaluationattendance/fetchStudents4Attendance/",
        method: "POST",
        data: ({
...
<script type="text/javascript">
  $(document).on('change', '.attendanceTypeStaff_Substitution', function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>mystaffevaluationattendance/saveAttendance/",
        data: ({
          stuid: stuid,
          attendanceDate:attendanceDate,
          attendanceType:attendanceType,
...
<script>
  $(document).ready(function() {
    function fetchNewAttendance(view = '') {
      $.ajax({
        url: "<?php echo base_url(); ?>mystaffevaluationattendance/attendanceNotification/",
        method: "POST",
        data: ({
          view: view
        }),
