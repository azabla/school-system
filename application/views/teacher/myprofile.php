          ...
          <div class="section-body">
            ...
            <div class="row">
                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                      ...
                      <form id="myProfile" method="POST">
                          ...
                          <div class="card-footer text-right">
                            <button class="btn btn-info" type="submit" name="changeprofile" id="update_my_profile_gs">Save Changes</button>
                          </div>
                        </form>
                      </div>
                      ...
                      <div class="tab-pane fade show" id="passwordd" role="tabpanel" aria-labelledby="password-tab2">
                          ...
                          <div class="row">
                              <div class="form-group col-lg-6 col-md-6 col-12">
                                ...
                                <div class="chat-box">
                                  <div class="card-footer chat-fdorm">
              ...
              <div class="col-12 col-md-12 col-lg-4">
                ...
                <div class="card StudentViewTextInfo">
                  <div class="card-header">
...
<script type="text/javascript">
  ...
  $(document).on('click', "input[name='twoFactorAuthenticatio']", function() {
    ...
    if($(this).is(':checked')){
      $.ajax({
        url:"<?php echo base_url() ?>miprofile/enable_two_factor_authentication/",
        method:"POST",
        data:({
          twofactor:twofactor
        }),
      ...
      var twofactor=$(this).attr("value");
      $.ajax({
        url:"<?php echo base_url() ?>miprofile/disable_two_factor_authentication/",
        method:"POST",
        data:({
           twofactor:twofactor
        }),
  ...
  $(document).ready(function(){
    ...
    function on_off_registration_page() {
      $.ajax({
        method:'POST',
        url:'<?php echo base_url() ?>miprofile/two_factor_authentication/',
        cache: false,
        beforeSend: function() {
...
savePNGButton.addEventListener("click", function (event){
  ...
  if (signaturePad.isEmpty()){
    ...
    document.getElementById("signature").value = dataUrl;
     $.ajax({
      method: "POST",
      url: "<?php echo base_url(); ?>miprofile/updateSignature/",
      data: ({
        dataUrl:dataUrl
      }),
      beforeSend: function() {
...
<script type="text/javascript">
  $(document).on('submit', '#myProfile', function(e) {
    ...
    $.ajax({
      method: "POST",
      url: "<?php echo base_url(); ?>miprofile/updateMyProfile/",
  ...
  $('#changePassword').on('submit', function(event) {
    ...
    var newPassword=$('#newPassword').val();
      if( $('#newPassword').val() =='' || $('#oldPassword').val() =='')
      {
        ...
        $.ajax({
        method: "POST",
        url: "<?php echo base_url(); ?>miprofile/changePassword/",
        data: ({
