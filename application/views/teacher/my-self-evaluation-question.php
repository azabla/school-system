...
<script type="text/javascript">
  ...
  {
    $.ajax({
      url:"<?php echo base_url(); ?>myselfevaluationquestion/fetch_my_newself_evaluation_questions/",
      method:"POST",
      beforeSend: function() {
  ...
  $(document).on('click', '.backToTitlePage', function()
  {
   ...
   $(document).on('click', '#answer_this_self_evaluation_question', function(e) {
    ...
    $.ajax({
      method: "POST",
      url: "<?php echo base_url(); ?>myselfevaluationquestion/fetch_myself_evaluation_questions/",
      data: {
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        if (question_answer.length!=0 ) {
          $.ajax({
            method: "POST",
            url: "<?php echo base_url(); ?>myselfevaluationquestion/submit_selfquestion_answer/",
            data: {
