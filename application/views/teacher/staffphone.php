...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>mystaffphone/fetchstaffPhoneList/",
        method:"POST",
        beforeSend: function() {
          $('#staffsPhoneList').html( 'Loading...<img src="<?php echo base_url(); ?>/img/loader.gif" alt="" width="24" height="24" id="loa">');
        },
