            ...
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-12">
                <div class="card">
                  <div class="boxs mail_listing">
                    ...
                    <div class="row">
                    <div class="col-lg-12">
                      <?php echo form_open_multipart('Addstudentlesson/');?>
                          ...
                          <div class="form-group">
                            <div class="form-line">
                              ...
                              id="title" name= "title" required="required" 
                               class="form-control" placeholder="Lesson or worksheet title here...">
                            </div>
                          </div>
                           <textarea class="form-control summernote-simple bio" id="note" name="note" placeholder="Lesson note here..." 
                           required="required">
                           </textarea>
