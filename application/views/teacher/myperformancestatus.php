...
<body>
    ...
    $(document).ready(function(){
      $('#fetchStaffToEditActivity').on('click', function(event) {
        ...
        if($('#activityBranch').val() =='' || $('#activity_week').val()=='--- Select Week ---')
        {
          ...
          $.ajax({
          method: "POST",
          url: "<?php echo base_url(); ?>myperformancestatus/fetch_signed_nonsigned_staffs/",
          data: ({
  ...
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>myperformancestatus/fetch_performance_onoff/",
        method:"POST",
        beforeSend: function() {
    ...
    $(document).on('click', "input[name='onoff_their_result']", function() {
      ...
      if($(this).is(':checked')){
        $.ajax({
          url:"<?php echo base_url() ?>myperformancestatus/saveLockMarkAuto/",
          method:"POST",
          data:({
            lockmark:lockmark,
            per_week:per_week
      ...
      var per_week=$(this).attr("id");
        $.ajax({
          url:"<?php echo base_url() ?>myperformancestatus/deleteLockMarkAuto/",
          method:"POST",
          data:({
             lockmark:lockmark,
             per_week:per_week
