                    ...
                    <div class="col-lg-12">
                      <form class="StudentViewTextInfo" id="formCompose">
                        ...
                        <div class="col-lg-4">
                          ...
                          <textarea class="student_message_area" rows="4" cols="50" wrap="physical" name="message" id="student_message_area" style="width:100%; height:100px;" required="required" placeholder="Write your message here..."></textarea>
  ...
  <script type="text/javascript">
    $(document).on('click', '#sending_message', function(event) {
      ...
      if(commentvalue.length  ==0 || username.length==0 || $("#message_title").val()==''){
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo base_url(); ?>messagecompose/composeMessage/",
          data: ({
            message_to: username,
    ...
    $(document).ready(function() {
        $("#usertype").change(function() {
          var usertype=$("#usertype").val();
            $.ajax({
                method: "POST",
                url: "<?php echo base_url(); ?>Usertypeteacherdirector/",
