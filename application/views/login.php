...
<body>
          ...
          <div class="row">
            <div class="col-lg-8 col-8">
              <div class="alert alert-info">
                <marquee> Exciting News: Admissions open for <?php echo $currentYear ?> Academic year. Don't miss out –
                  register your children today to secure their spot! </marquee>
              </div>
            </div>
    ...
    <div class="container">
      <section id="ccr-left-section" class="col-md-8">
        <section id="ccr-slide-main" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            ...
            <?php if($countt == 0) { ?> <div class="active item">
              <?php } else{ ?> <div class="item"> <?php } ?>
                <div class="container slide-element">
                  <img src="<?php echo base_url(); ?>/gallery/<?php echo $fetch_single_gallery->gname;?>"
            ...
            <a class="carousel-control left" href="#ccr-slide-main" data-slide="prev"><i
                class="fa fa-arrow-left"></i></a>
            <a class="carousel-control right" href="#ccr-slide-main" data-slide="next"><i
        ...
        <section id="" class="col-md-6">
          <div class="ccr-gallery-ttile">
            <span></span>
            <p>Vision Statement of Diamond Academy updated last of last</p>
          </div><br>
          <section class="">
            <div class="featured-sports-news-post">
              <i class="fa fa-chevron-right"></i> To be the best academic institution in Ethiopia capable of producing
              highly qualified professionals who can contribute to the indigenous capacity building of the nation.
            </div>
          </section>
        </section>
        <section id="" class="col-md-6">
          <div class="ccr-gallery-ttile">
            <span></span>
            <p>Mission Statement of Diamond Academy edited22</p>
          </div><br>
          <section class="featured-sports-news">
            <div class="featured-sports-news-post">
              <p><i class="fa fa-chevron-right"></i> To provide conducive and nurturing habitat for our students and
                teachers</p>
              ...
              <p><i class="fa fa-chevron-right"></i> To create safe and friendly learning and working environment for
                our students and staff members</p>
            </div>
          </section>
        </section>
      ...
      <aside id="ccr-right-section" class="col-md-4 ccr-home">
        <section id="ccr-calender">
          ...
          <div class="featured-sports-news-post">
            <?php echo substr($school->about,0,700); ?>...<a href="<?php echo base_url(); ?>about/"><button
        ...
        <section id="ccr-sidebar-newslater">
          ...
          <div class="sidebar-newslater-form">
            <p><strong><i class="fa fa-chevron-right"></i> LEARNING TO LEARN:</strong> Implies learning how to learn by
              developing one's Concentration, Memory Skills and Ability to Think.</p>

            <p><strong><i class="fa fa-chevron-right"></i> LEARNING TO DO:</strong> represents the skillful, creative,
              and discerning application of knowledge.To perform a job or work, the learning to do must be fulfilled.
              This entails the acquisition of competence that enables people to deal with a variety of situations and to
              work in teams.</p>

            <p><strong><i class="fa fa-chevron-right"></i> LEARNING TO BE:</strong> it refers to the role of education
              in developing all the dimensions of the complete person: to achieve the physical, intellectual, emotional
              and ethical integration of individual into a complete man. </p>

            <p><strong><i class="fa fa-chevron-right"></i> LEARNING TO LIVE TOGETHER:</strong> can be achieved by
              developing an understanding of others and their history, traditions and spiritual values, and appreciation
              of interdependence. Teachers should help the students realize the value of being able to live together, in
              their gradually enlarging world: home, school, community, city, town, province, country, and the world as
              a global village. This is vital in building a genuine and lasting culture of peace in the world.</p>
          </div>
        </section>
        ...
        <section id="sidebar-popular-post">
          ...
          <ul>
            ...
            <li>
              <a href="<?php echo base_url()?>singlepage?blog=<?php echo $pageTitle; ?>"
                class="media-left"><?php echo $blog->ntitle;?><img
                  src="<?php echo base_url(); ?>/news/<?php echo $blog->photo;?>" style="height: 50px;" alt="..."></a>
    ...
    <div class="container">
      <ul>
        ...
        <li class="col-md-3">
          ...
          <ul>
            <?php foreach($blogs as $blog){ $pageTitle=$blog->ntitle; ?>
            <li><a href="<?php echo base_url()?>singlepage?blog=<?php echo $pageTitle; ?>" class="media-left"><img
                  src="<?php echo base_url(); ?>/news/<?php echo $blog->photo;?>" style="height: 50px;" alt="...">
                <?php echo $blog->ntitle;?> </a></li>
            <?php } ?>
          </ul>
        </li>
      </ul>
  ...
  <footer id="ccr-footer" class="container">
    <div class="container">
      <div class="copyright">
        All Rights Reserved &copy; <?php echo date('Y') ?> Copyrights <a href="http://grandstande.com">Grandstande IT
          Solution Plc</a>
      </div>
    </div>
  </footer>
