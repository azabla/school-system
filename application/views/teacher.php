  ...
  <div class="container">
    <section id="ccr-left-section" class="col-md-8">
      <div class="ccr-gallery-ttile">
          <span></span> 
          <p><strong>School Teachers</strong></p>
        </div>
      <section id="ccr-blog-s2">
        <ul>
          <?php foreach($fetch_all_teachers as $teacher){ ?>
          <li>
            <article>
              <figure class="blog-thumbnails">
              <img src="<?php echo base_url(); ?>/profile/<?php echo $teacher->profile;?>" alt="Article Image ">
              </figure> <
              <div class="blog-text">
                <h4><a href="#"><?php echo $teacher->fname;echo ' ' ;echo $teacher->mname;?></a></h4>
                <p class="">
