  ...
  <div class="container">
    <section id="ccr-left-section" class="col-md-8">
      <section id="ccr-contact-form">
        ...
        <?php } ?>
        <form action="<?php echo base_url() ?>forgotpassword/" method="POST" role="form" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6 form-group">
              <input type="email" name="email" class="form-control" id="name" placeholder="Enter your email to reset password" required>
            </div>
            <div class="col-md-6 form-group">
              <button class="btn btn-block" type="submit" name="resetpassword">Send</button>
            </div>
            <div class="col-md-6 form-group">
              <a href="<?php echo base_url(); ?>loginpage/" class="pull-right">Want to Login?
              </a>
            </div>
          </div>
        </form>
