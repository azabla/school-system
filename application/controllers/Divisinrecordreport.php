...
class Divisinrecordreport extends CI_Controller {
	...
	public function index($page='divisionrecordreport')
	{
    ...
    function FecthThisDivStudent(){
        ...
        if($this->input->post('gs_gradesec')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetch_thisdiv_branchstudents($gs_branches,$gs_gradesec,$grands_academicyear);
            }else{
                echo $this->main_model->fetch_thisdiv_branchstudents($mybranch,$gs_gradesec,$grands_academicyear);
            }
        }
    }
}