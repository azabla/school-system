...
class Myidcard extends CI_Controller {
    ...
    function Filter_grade_from_branch(){
        ...
        if($this->input->post('branchit')){
            ...
            if($accessbranch === '1'){
                ...
                echo $this->main_model->fetchGradeFromBranchTransport($mybranch,$grands_academicyear); 
            }
        }
    }
    ...
    function filterServicePlace(){
        ...
        if($this->input->post('branchit')){
            ...
            if($accessbranch === '1'){
                ...
                echo $this->main_model->fetch_servicePlace_branch($mybranch,$grands_academicyear);
            }
        }
    }
    function fetchStudentIdcard(){
        ...
        if($this->input->post('servicePlace')){
            ...
            if($accessbranch === '1'){
                echo $this->main_model->fetch_student_idcard_seattle($reportaca,$checkStudent,$gradesec,$check,$branch,$gyear); 
            }else{
                echo $this->main_model->fetch_student_idcard_seattle($reportaca,$checkStudent,$gradesec,$check,$mybranch,$gyear); 
            } 
        }
    }
    function fetchStudentIdcardWithoutPlace(){
        ...
        if($this->input->post('studentList')){
            ...
            if($accessbranch === '1'){
                echo $this->main_model->fetchStudentIdCardSeattle($reportaca,$checkStudent,$gradesec,$branch,$gyear);
            }else{
                echo $this->main_model->fetchStudentIdCardSeattle($reportaca,$checkStudent,$gradesec,$mybranch,$gyear);
            }
        }
    }
    ...
    function fetchCustomIDCard(){
        ...
        if($this->input->post('stuIdArray')){
            ...
            if($accessbranch === '1'){
                echo $this->main_model->fetchStudentCustomIdCardSeattle($max_year,$checkStudent,$gyear);
            }else{
                echo $this->main_model->fetchStudentCustomIdCardSeattle($max_year,$checkStudent,$gyear);
            }
        } 
