...
class Myhomepage extends CI_Controller {
	...
	public function index($page='home')
  {
    ...
    if($userLevel=='3' && trim($_SESSION['usertype'])!==''){
      $dataArray=array();
      $query_gradesec = $this->db->query("select username ,fname,mname,grade from users where username='$user' and academicyear='$max_year' ");
