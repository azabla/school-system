...
class Markstatistics extends CI_Controller {
  ...
  function thisMarkStatistics(){
    ...
    if($this->input->post('gradeStatistics')){
      ...
      /*if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){*/
        echo $this->main_model->mark_statisticsSeattle($max_year,$gradeItems,$subjectItems,$quarter);
      /*}else{
  ...
  function thisGradeMarkStatistics(){
    ...
    if($this->input->post('grade_statistics')){
      ...
      if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
        echo $this->main_model->gradeMarkStatistics($max_year,$branch,$grade,$subjects,$QuarterItems,$countQuarter,$nameChecked,$countSubject);
      }else{
        echo $this->main_model->gradeMarkStatistics($max_year,$mybranch,$grade,$subjects,$QuarterItems,$countQuarter,$nameChecked,$countSubject);
      }
    } 
  }
}