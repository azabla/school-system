...
class Idcard extends CI_Controller {
    ...
    function fetchStudentIdcard(){
        ...
        if($this->input->post('servicePlace')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetch_student_idcard_primebridge($reportaca,$checkStudent,$gradesec,$check,$branch,$gyear); 
            }else{
                echo $this->main_model->fetch_student_idcard_primebridge($reportaca,$checkStudent,$gradesec,$check,$mybranch,$gyear); 
            } 
        }
    }
    function fetchStudentIdcardWithoutPlace(){
        ...
        if($this->input->post('studentList')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchStudentIdCard_PrimeBridge($reportaca,$checkStudent,$gradesec,$branch,$gyear);
            }else{
                echo $this->main_model->fetchStudentIdCard_PrimeBridge($reportaca,$checkStudent,$gradesec,$mybranch,$gyear);
            }
        }
    }
    ...
    function fetchCustomIDCard(){
        ...
        if($this->input->post('stuIdArray')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchStudentCustomIdCard_primebridge($max_year,$checkStudent,$gyear);
            }else{
                echo $this->main_model->fetchStudentCustomIdCard_primebridge($max_year,$checkStudent,$gyear);
            }
        } 
    ...
    public function fetchBackIdCard(){
        ...
        if($this->input->post('pageNumber')){
            ...
            echo $this->main_model->fetchBackIdCard_Primebrdige($pageNumber,$max_year,$gyear,$branchIDBack,$gradesecIDBack);
        }
    } 
}