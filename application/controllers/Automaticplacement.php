...
class Automaticplacement extends CI_Controller {
    ...
    public function index($page='autoplacement')
    {
    ...
    function checkPlacementFound(){
        ...
        if($this->input->post('grade2place')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->check_placement_found($branch2place,$grade2place,$max_year); 
            }else{
    ...
    function filterGrade4AutoPlacement(){
        ...
        if($this->input->post('grade2place')){
            ...
            echo $this->main_model->fetch_grade_4autoplacement($branch2place,$grade2place,$into,$max_year);
        }
    } 
}