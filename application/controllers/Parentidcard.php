...
class Parentidcard extends CI_Controller {
	...
	public function index($page='parentidcard')
	{
    ...
    function fetchStudentIdcard(){
        ...
        if($this->input->post('servicePlace')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetch_parent_idcard($reportaca,$checkStudent,$gradesec,$check,$branch,$gyear); 
            }else{
                echo $this->main_model->fetch_parent_idcard($reportaca,$checkStudent,$gradesec,$check,$mybranch,$gyear); 
            } 
        }
    }
    function fetchStudentIdcardWithoutPlace(){
        ...
        if($this->input->post('studentList')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchParentIdCard($reportaca,$checkStudent,$gradesec,$branch,$gyear);
            }else{
                echo $this->main_model->fetchParentIdCard($reportaca,$checkStudent,$gradesec,$mybranch,$gyear);
            }
        }
    }
    ...
    function fetchCustomIDCard(){
        ...
        if($this->input->post('stuIdArray')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchParentCustomIdCard($max_year,$checkStudent,$gyear);
            }else{
                echo $this->main_model->fetchParentCustomIdCard($max_year,$checkStudent,$gyear);
            }
        } 
