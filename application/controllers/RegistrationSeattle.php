...
class Registration extends CI_Controller {
    ...
    function studentPromotionPromoted(){
        if($this->input->post('stuid')){
            ...
            foreach($stuid as $stuidNow){
                echo $this->main_model->studentPromotionPromoteSeattle($stuidNow,$academicyear); 
            }
        } 
    }
    function studentPromotionPromotedN(){
        if($this->input->post('stuid')){
            ...
            $academicyear=$this->input->post('academicyear');
            foreach($stuid as $stuidNow){
                echo $this->main_model->studentPromotionPromoteSeattleN($stuidNow,$academicyear); 
            }
        } 
    }
    function studentPromotionPromotedS(){
        if($this->input->post('stuid')){
            ...
            $academicyear=$this->input->post('academicyear');
            foreach($stuid as $stuidNow){
                echo $this->main_model->studentPromotionPromoteSeattleS($stuidNow,$academicyear); 
            }
        } 
    }
    ...
    function startAutoPromotion(){
        if($this->input->post('toAcademicYear')){
            ...
            if($fromAcademicYear >= $toAcademicYear){
               ...
               echo $this->main_model->startAutoPromotionSeattle($fromAcademicYear,$toAcademicYear); 
            }
        }
    }
}