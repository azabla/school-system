...
class Myidcard extends CI_Controller {
    ...
    function fetchStudentIdcard(){
        ...
        if($this->input->post('servicePlace')){
            ...
            if($accessbranch === '1'){
                echo $this->main_model->fetch_student_idcard($reportaca,$checkStudent,$gradesec,$check,$branch,$gyear); 
            }else{
                echo $this->main_model->fetch_student_idcard($reportaca,$checkStudent,$gradesec,$check,$mybranch,$gyear); 
            } 
        }
    }
    function fetchStudentIdcardWithoutPlace(){
        ...
        if($this->input->post('studentList')){
            ...
            if($accessbranch === '1'){
                echo $this->main_model->fetchStudentIdCard($reportaca,$checkStudent,$gradesec,$branch,$gyear);
            }else{
                echo $this->main_model->fetchStudentIdCard($reportaca,$checkStudent,$gradesec,$mybranch,$gyear);
            }
        }
    }
