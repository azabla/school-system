...
class Gradephonebook extends CI_Controller {
   public function __construct(){
	...
	public function index($page='gradephonebook')
	{
  ...
  function Fetch_gradephone(){
    ...
    if($this->input->post('gradesec')){
      ...
      echo $this->main_model->fetch_gradephone($grands_academicyear,$grade,$branch); 
    }
  }
}