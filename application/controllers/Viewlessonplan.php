...
class Viewlessonplan extends CI_Controller {
  public function __construct(){
    ...
    if($this->session->userdata('username') == '' || $upViewLplan->num_rows()<1 || $userLevel!='1'){
    ...
    $data['lessonplan']=$this->main_model->viewLessonPlan($max_year);
