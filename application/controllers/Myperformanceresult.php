...
class Myperformanceresult extends CI_Controller {
  public function __construct(){
    ...
    if($this->session->userdata('username') == '' || $usergroupPV->num_rows()<1 || $userLevel!='1'){
	...
	public function index($page='myperformanceresult')
	{
