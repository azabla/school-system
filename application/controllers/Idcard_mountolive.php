...
class Idcard extends CI_Controller {
    ...
    function fetchStudentIdcardWithoutPlace(){
        ...
        if($this->input->post('studentList')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchStudentIdCard_Mountolive($reportaca,$checkStudent,$gradesec,$branch,$gyear);
            }else{
                echo $this->main_model->fetchStudentIdCard_Mountolive($reportaca,$checkStudent,$gradesec,$mybranch,$gyear);
            }
        }
    }
    ...
    function fetchCustomIDCard(){
        ...
        if($this->input->post('stuIdArray')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchStudentCustomIdCard_Mountolive($max_year,$checkStudent,$gyear);
            }else{
                echo $this->main_model->fetchStudentCustomIdCard_Mountolive($max_year,$checkStudent,$gyear);
            }
        } 
