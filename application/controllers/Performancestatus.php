...
class Performancestatus extends CI_Controller {
  public function __construct(){
	...
	public function index($page='performancestatus')
	{
  ...
  function fetch_performance_onoff(){
    ...
    if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
      echo $this->main_model->fetch_performance_onoff($max_year);
    }else{
  ...
  function fetch_signed_nonsigned_staffs(){
    ...
    if(isset($_POST['activityYear'])){
      ...
      if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
        ...
        echo $this->main_model->fetch_signed_nonsigned_staffs_my($activityYear,$branch,$activity_week,$userType);
      }
    }
  }
}