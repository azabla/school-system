...
class Attendance extends CI_Controller {
    ...
    function fetchStudents4Attendance(){
        ...
        if($this->input->post('attBranches')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetch_gradesec_student_kelem($attGradesec,$attBranches,$max_year,$dateAttendance,$user); 
            }else{
                echo $this->main_model->fetch_gradesec_student_kelem($attGradesec,$branch,$max_year,$dateAttendance,$user); 
            }
        }
    }
    ...
    function fetchSectionStudentsAttendance(){
        ...
        if($this->input->post('attBranches')){
            ...
            $attBranches=$this->input->post('attBranches');
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchSectionStudentsAttendance($grade,$attBranches,$max_year); 
            }else{
                echo $this->main_model->fetchSectionStudentsAttendance($grade,$branch,$max_year); 
            }
        }
    }
    function fetchCustomStudentsAttendance(){
        ...
        if($this->input->post('attBranches')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->fetchCustomStudentsAttendance_kelem($check,$attBranches,$customToDate,$customFromDate,$max_year); 
            }else{
                echo $this->main_model->fetchCustomStudentsAttendance_kelem($check,$branch,$customToDate,$customFromDate,$max_year); 
            }
        }
    }
