...
class Registration extends CI_Controller {
    ...
    function studentPromotionPromoted(){
        if($this->input->post('stuid')){
            ...
            foreach($stuid as $stuidNow){
                echo $this->main_model->studentPromotionPromoteENS($stuidNow,$academicyear); 
            }
        } 
    }
    function studentPromotionPromotedN(){
        if($this->input->post('stuid')){
            ...
            $academicyear=$this->input->post('academicyear');
            foreach($stuid as $stuidNow){
                echo $this->main_model->studentPromotionPromoteENSN($stuidNow,$academicyear); 
            }
        } 
    }
    function studentPromotionPromotedS(){
        if($this->input->post('stuid')){
            ...
            $academicyear=$this->input->post('academicyear');
            foreach($stuid as $stuidNow){
                echo $this->main_model->studentPromotionPromoteENSS($stuidNow,$academicyear); 
            }
        } 
    }
