...
class Graderankreport extends CI_Controller {
	...
	public function index($page='graderankreport')
	{
    ...
    function fetchTopRank(){
        ...
        if($this->input->post('gradesec')){
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                echo $this->main_model->topGradeTopRank($max_year,$quarter,$gradesec,$branch,$top); 
            }else{
                echo $this->main_model->topGradeTopRank($max_year,$quarter,$gradesec,$mybranch,$top); 
            }
        }
    }
}