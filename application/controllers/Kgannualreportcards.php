...
class Kgannualreportcards extends CI_Controller {
    ...
    public function index($page='kgannualreportcards')
    {
            ...
            if($_SESSION['usertype']===trim('superAdmin') || $accessbranch === '1'){
                ...
                if($query){
                    if($uGrade === 'KG1'){
                        ...
                        $data=$this->Reportcard_model->KgannualreportcardFinalKG2($reportaca,$gradesec,$branch,$max_quarter,$startDate1,$endDate1);
                        echo json_encode($data);
                    }else{
                        $data=$this->Reportcard_model->KgannualreportcardFinalKG3($reportaca,$gradesec,$branch,$max_quarter,$startDate1,$endDate1);
                        echo json_encode($data);
                    }
                ...
                if($query){
                    if($uGrade === 'KG1'){
                        ...
                        $data=$this->Reportcard_model->KgannualreportcardFinalKG2($reportaca,$gradesec,$mybranch,$max_quarter,$startDate1,$endDate1);
                        echo json_encode($data);
                    }else{
                        $data=$this->Reportcard_model->KgannualreportcardFinalKG3($reportaca,$gradesec,$mybranch,$max_quarter,$startDate1,$endDate1);
                        echo json_encode($data);
                    }
                }
            }
